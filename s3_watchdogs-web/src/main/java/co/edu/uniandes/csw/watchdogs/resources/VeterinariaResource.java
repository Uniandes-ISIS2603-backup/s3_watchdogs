 ...
 * "/api" y este recurso tiene la ruta "veterinarias".</i>
 *
 * <h2>Anotaciones </h2>
 * <pre>
...
public class VeterinariaResource {
     ...
     * </pre>
     *
     * @param veterinaria {@link VeterinariaDetailDTO} - La veterinaria que se
     * desea guardar.
     * @return JSON {@link veterinariaDetailDTO} - La veterinaria guardada con
     * el atributo id autogenerado.
     * @throws BusinessLogicException Error de logica que se genera cuando ya
     * existe la veterinaria.
     */
    @POST
     ...
     * </pre>
     *
     * @return JSONArray {@link VeterinariaDetailDTO} - Las veterinarias
     ...
     * </pre>
     *
     * @param id Identificador de la veterinaria que se esta buscando. Este debe
    ...
    /**
     * <h1>PUT /api/veterinarias/{id} : Actualizar veterinaria con el id
     * dado.</h1>
     ...
     * </pre>
     *
     * @param id Identificador de la veterinaria que se desea actualizar. Este
     * debe ser una cadena de dígitos.
     * @param veterinaria {@link VeterinariaDetailDTO} La veterinaria que se
     * desea guardar.
     * @return JSON {@link VeterinariaDetailDTO} - La veterinaria guardada.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera al no poder actualizar la veterinaria
     ...
     * </pre>
     *
     * @param id Identificador de la veterinaria que se desea borrar. Este debe
     * ser una cadena de dígitos.
     * @throws co.edu.uniandes.csw.watchdogs.exceptions.BusinessLogicException
     */
    @DELETE
