 ...
 * "/api" y este recurso tiene la ruta "aseos".</i>
 *
 * <h2>Anotaciones </h2>
 * <pre>
...
public class AseoResource {
     ...
     * @return JSON {@link AseoDetailDTO} - Servicio de aseo guardado con el
     * atributo id autogenerado.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera cuando ya existeel servicio de aseo.
     */
    @POST
     ...
     * </pre>
     *
     * @return JSONArray {@link AseoDetailDTO} - Los servicios de aseo
     ...
     * </pre>
     *
     * @param id Identificador del servicio de aseo que se esta buscando. Este
    ...
    /**
     * <h1>PUT /api/aseos/{id} : Actualizar el servicio de aseo con el id
     * dado.</h1>
     * <pre>Cuerpo de petición: JSON {@link AseoDetailDTO}.
     *
     ...
     * </pre>
     *
     * @param id Identificador del servico de aseo que se desea actualizar.Este
     * debe ser una cadena de dígitos.
     * @param aseo {@link AseoDetailDTO} El servicio de aseo que se desea
     * guardar.
     * @return JSON {@link AseoDetailDTO} - El servicio de aseo guardado.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera al no poder actualizar el servicio de aseo
     ...
     * </pre>
     *
     * @param id Identificador del servicio de aseo que se desea borrar. Este
     * debe ser una cadena de dígitos.
     * @throws co.edu.uniandes.csw.watchdogs.exceptions.BusinessLogicException
     */
    @DELETE
