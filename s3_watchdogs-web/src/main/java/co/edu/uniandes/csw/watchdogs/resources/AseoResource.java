...
public class AseoResource {
    ...
    /**
     * <h1>POST /api/aseo : Crear un servicio de aseo.</h1>
     * 
     * <pre>Cuerpo de peticion: JSON{@link AseoDetailDTO}.
     * 
     ...
     * 200 OK Creo el nuevo servicio de aseo.
     * </code>
     ...
     * @return JSON {@link AseoDetailDTO} - El servicio de aseo guardado con el atributo id autogenerado.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} - Error de logica que se genera cuando ya existe el servicio de aseo.
     */
    @POST
    public AseoDetailDTO createAseo( AseoDetailDTO cliente ) throws BusinessLogicException
    {
        return aseo;
    }
