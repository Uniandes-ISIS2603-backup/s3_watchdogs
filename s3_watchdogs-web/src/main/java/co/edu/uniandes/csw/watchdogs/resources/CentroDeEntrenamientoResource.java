...
public class CentroDeEntrenamientoResource {
    ...
    /**
     * <h1>POST /api/centrosDeEntrenamiento : Crear un
     * CentroDeEntrenamiento.</h1>
     *
     ...
     * </pre>
     *
     * @param centroDeEntrenamiento {@link CentroDeEntrenamientoDetailDTO} - El
     * CentroDeEntrenamiento que se desea guardar.
     * @return JSON {@link CentroDeEntrenamientoDetailDTO} - El
     * CentroDeEntrenamiento guardado con el atributo id autogenerado.
     * @throws BusinessLogicException {@link BusinessLogicException} - Error de
     * lógica que se genera cuando ya existe el CentroDeEntrenamiento.
     */
    @POST
    ...
    /**
     * <h1>GET /api/centrosDeEntrenamiento : Obtener todos los
     * centrosDeEntrenamiento.</h1>
     *
     ...
     * </pre>
     *
     * @return JSONArray {@link CentroDeEntrenamientoDetailDTO} - Los
     * centrosDeEntrenamiento encontrados en la aplicación. Si no hay ninguna
    ...
    /**
     * <h1>GET /api/centrosDeEntrenamiento/{id} : Obtener CentroDeEntrenamiento
     * por id.</h1>
     *
     ...
     * </pre>
     *
     * @param id Identificador del CentroDeEntrenamiento que se esta buscando.
     * Este debe ser una cadena de dígitos.
     * @return JSON {@link CentroDeEntrenamientoDetailDTO} - El
     * CentroDeEntrenamiento buscada
     */
    @GET
    @Path("{id: \\d+}")
    ...
    /**
     * <h1>PUT /api/centrosDeEntrenamiento/{id} : Actualizar
     * CentroDeEntrenamiento con el id dado.</h1>
     * <pre>Cuerpo de petición: JSON {@link CentroDeEntrenamientoDetailDTO}.
     *
     ...
     * </pre>
     *
     * @param id Identificador de el CentroDeEntrenamiento que se desea
     * actualizar.Este debe ser una cadena de dígitos.
     * @param centroDeEntrenamiento {@link CentroDeEntrenamientoDetailDTO} el
     * CentroDeEntrenamiento que se desea guardar.
     * @return JSON {@link CentroDeEntrenamientoDetailDTO} - el
     * CentroDeEntrenamiento guardado.
     * @throws BusinessLogicException {@link BusinessLogicException} - Error de
     * lógica que se genera al no poder actualizar el CentroDeEntrenamiento
    ...
    /**
     * <h1>DELETE /api/centrosDeEntrenamiento/{id} : Borrar
     * CentroDeEntrenamiento por id.</h1>
     *
     ...
     * </pre>
     *
     * @param id Identificador de el CentroDeEntrenamiento que se desea borrar.
     * Este debe ser una cadena de dígitos.
     */
    @DELETE
    @Path("{id: \\d+}")
    ...
    /**
     * Conexión con el servicio de entrenamientos para un CentroDeEntrenamiento.
     * {@link ReviewResource}
     *
     * Este método conecta la ruta de /centrosDeEntrenamiento con las rutas de
     * /entrenamientos que dependen del CentroDeEntrenamiento, es una
     * redirección al servicio que maneja el segmento de la URL que se encarga
     * de los libros.
     *
     * @param centrosDeEntrenamientoId El ID del CentroDeEntrenamiento con
     * respecto al cual se accede al servicio.
     * @return El servicio de entrenamientos para esa CentroDeEntrenamiento en
     * paricular.
     */
    ...
    /**
     * Conexión con el servicio de hoteles para un CentroDeEntrenamiento.
     * {@link ReviewResource}
     *
     * Este método conecta la ruta de /centrosDeEntrenamiento con las rutas de
     * /hoteles que dependen del CentroDeEntrenamiento, es una redirección al
     * servicio que maneja el segmento de la URL que se encarga de los libros.
     *
     * @param centrosDeEntrenamientoId El ID del CentroDeEntrenamiento con
     * respecto al cual se accede al servicio.
     * @return El servicio de entrenamientos para esa CentroDeEntrenamiento en
     ...
     *
     * Este método convierte una lista de objetos CentroDeEntrenamientoEntity a
     * una lista de objetos CentroDeEntrenamientoDetailDTO (json)
     *
     * @param entityList corresponde a la lista de CentroDeEntrenamientoes de
